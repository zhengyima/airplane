...
from ElementaryFunctions import my_max, my_min
...
def computeDubinsLSR(R=None, cls=None, cre=None, anglstart=None, anglend=None):
    ...
    acos_value = my_max( acos_value,-1 )
    acos_value = my_min( acos_value,1 )
    if ell == 0:
        theta2 = 0
    else:
...
def computeDubinsRSL(R=None, crs=None, cle=None, anglstart=None, anglend=None):
    ...
    if fabs( asin_value ) > 1:
        ...
        flag_zero = 0
    asin_value = my_max( asin_value, -1 )
    asin_value = my_min( asin_value, 1 )
    if ell == 0:
        theta2 = 0
    else:
